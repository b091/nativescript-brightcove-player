import {BrightcovePlayer as ButtonDefinition} from './index';
...
export abstract class Common extends View implements ButtonDefinition {
...
// Defines 'text' property on Common class.
...
(Common.prototype as any).recycleNativeView = false;